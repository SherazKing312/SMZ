...
def iAmMethod2Ua():
	...
	ua = f"Dalvik/2.1.0 (Linux; U; Android {random.randint(6,13)}; {sm} Build/TP1A.220{random.randint(620,650)}.014) [[FBAN/FB4A;FBAV/223.0.0.330;FBBV/924202270;FBDM/{density=23.0,width=6480,height=11200};FBLC/en_BD;FBRV/662382680;FBCR/DhakaCityV23;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-S923U;FBSV/33;nullFBCA/armeabi-v29a:armeabi-v28a;]]"
	return ua
##############_________#########
def iAmMethod100Ua():
        samsung_models = [
